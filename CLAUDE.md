...
mktask/
  ...
  relations.json    seed for the relations table (blocks / blocked by, relates to)
    refs.js         the `task-refs` widget: drop/paste/pick a file, selected-reference preview,
                    "Go to" a linked task (table.select on the Tasks pane)
